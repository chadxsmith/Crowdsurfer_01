  ...
  $('input:checkbox').change(function(event){
    ...
    $.post('/search', { genre: searchTerm }, function(data){
      ...
      for (var i = 0; i < data.businesses.length; i++) {
        ...
        $('#results').append("<div class='row'><div class='col-md-12'><div class='venue'><div class='col-md-4'><img class='venue-img' src='" + venueImg + "'></div><div class='col-md-6'><h3 class='content__header--xsmall'><a class='content__header--small' href='" + venue['url'] + "' target='_blank'>" + venue['name'] + "</a> " + rating + "</h3><p class='content__header--xxsmall'>" + addressBlock + "</p><hr> </div></div></div></div>");
      };
    });
  });
});